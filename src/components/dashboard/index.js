...
export { ScanQRPage } from './pages/ScanQRPage'
export { Sales } from './pages/Sales'
export { Cotizaciones } from './pages/Cotizaciones'
...
export { Clientes } from './pages/Clientes'
export { Almacenes } from './pages/Almacenes'
export { Compras } from './pages/Compras'
