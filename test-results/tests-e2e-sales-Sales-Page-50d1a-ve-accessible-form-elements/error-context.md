...
- Name: tests\e2e\sales.spec.js >> Sales Page E2E Tests >> should have accessible form elements
- Location: tests\e2e\sales.spec.js:169:3
...
Locator: locator('input[placeholder*="Buscar"]')
Expected: visible
Timeout: 5000ms
